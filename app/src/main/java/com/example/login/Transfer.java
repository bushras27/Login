            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (tab.getPosition()) {
                    case 0: // Expense tab
                        ...
                        Intent expenseIntent = new Intent(Transfer.this, Expense1.class); // Replace with your actual IncomeActivity
                        startActivity(expenseIntent);
                        break;

                    case 1: // Income tab
                        // Open the IncomeActivity when Income tab is selected
                        Intent transferIntent = new Intent(Transfer.this, Income1.class); // Replace with your actual IncomeActivity
